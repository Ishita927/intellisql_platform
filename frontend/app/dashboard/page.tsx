...
//         </h1>
//         <p className="text-slate-400 mb-10">Here's your workspace overview.</p>

//         <div className="grid md:grid-cols-3 gap-5">
//           <InfoCard label="Your role" value={user.role.toUpperCase()} accent="indigo" />
//           <InfoCard label="Tenant ID" value={`#${user.tenant_id}`} accent="purple" />
//           <InfoCard label="Email" value={user.email} accent="emerald" />
//         </div>

//         <div className="grid md:grid-cols-2 gap-5 mt-6">
//           <Link
//             href="/dashboard/database"
//             className="block p-8 bg-slate-900/50 border border-slate-700 hover:border-indigo-500 rounded-2xl text-center transition group"
//           >
//             <p className="text-lg font-medium group-hover:text-indigo-300 transition">
//               🔌 Connect your database
//             </p>
//             <p className="text-sm text-slate-500 mt-1">
//               Link your company's PostgreSQL database
//             </p>
//           </Link>
...
//   };
//   return (
//     <div className={`p-6 rounded-2xl border bg-gradient-to-br to-transparent ${colors[accent]}`}>
